...
The deep convolutional neural network (CNN) proposed in the original study achieved an overall classification accuracy of approximately 93.4\% \cite{OP}, whereas the Random Forest model in this work achieved an accuracy of approximately 97.3\%.
